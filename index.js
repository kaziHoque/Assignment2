...
var SessionSchemavar  = new Schema({
  messages :  [{ type: Schema.Types.ObjectId, ref: 'tst' }]
...
var tst = mongoose.model('tst', tstSchema)
...
//////  // SAVING CHAT DATA TO DATABASE /////////////
        var new_tst = new tst(request.body);
        
        new_tst.session = localStorage.getItem('session');
        
  new_tst.save(function(err, data){
    if(err)
